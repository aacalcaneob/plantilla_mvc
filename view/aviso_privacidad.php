...
<html lang="es-MX">
	<head>
		...
		<title>Proyecto Básico MVC | AVISO DE PRIVACIDAD</title>
	</head>
	<body>
		<div class="container">
		    <div class="row">
		        <div class="col-md-12">
		            <div class="error-template">
		                <h1>Bienvenido a la Página de Aviso de Privacidad</h1>
		            </div>
		        </div>
		    </div>
		</div>
		<ul class="nav justify-content-center">
		  ...
		  <li class="nav-item">
		    <a class="nav-link disabled" href="<?=PROJECT_FOLDER_PATH?>/aviso_de_privacidad">Aviso de Privacidad</a>
		  </li>
		  <li class="nav-item">
