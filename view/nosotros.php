...
<html lang="es-MX">
	<head>
		...
		<title>Proyecto Básico MVC | NOSOTROS</title>
	</head>
	<body>
		<div class="container">
		    <div class="row">
		        <div class="col-md-12">
		            <div class="error-template">
		                <h1>Bienvenido a la Página de Nosotros</h1>
		            </div>
		        </div>
		    </div>
		</div>
		<ul class="nav justify-content-center">
		  ...
		  <li class="nav-item">
		    <a class="nav-link disabled" href="<?=PROJECT_FOLDER_PATH?>/nosotros">Nosotros</a>
		  </li>
		  <li class="nav-item">
